...
#' @param tol the convergence criterion which is measured by the l_2 norm of the difference of between the current solution and the solution in the last iteration.
#' @value The solution vector of the linear system specified in the function  
#' @export
