...
#' elnet_coord()
#'
#' @return The function will return a matrix of regression coefficients for each \eqn{\lambda} collected as column vectors, the simulated design matrix \eqn{X}, the simulated response matrix \eqn{Y}.
...
elnet_coord=function(){
  ...
  return(list(beta=beta_co,X=X,Y=Y))
}